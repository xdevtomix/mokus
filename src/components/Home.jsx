...
export default function Home({ translations, language, setLanguage }) {
    ...
    return (
        <div ref={containerRef} className="w-full h-full">
            ...
            <ActionButton cssClasses="fixed top-2 left-2" text={translations.menuOpener[language]} action={() => location.hash = '#menu-open'} />
